...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">Actualizar reservacion</a>
...
<div class="row" >
        ...
        <div class="card-header">Actualizar reservación</div>
        <div class="card-body">
        <form action="http://localhost:8080/actualizar-reservacion" method="post">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <div class="form-group col-md-2">
              ...
              <input type="number" class="form-control" id="inputZip" name="fecha_vencimiento">
            </div>
            <div class="form-group col-md-2">
