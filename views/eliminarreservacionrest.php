...
<div class="row" >
        ...
        <div class="card-body">
        <form action="http://localhost:8080/eliminar-reservacion" method="get">

        <div class="form-row">
          <div class="form-row">
            <div class="form-group col-md-12">
              <label for="inputCity">Ingresa el id de la reservación a eliminar</label>
              <input type="number" class="form-control" id="inputCity" name="id_reservacion">
            </div>
