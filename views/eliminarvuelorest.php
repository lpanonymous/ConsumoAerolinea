...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">Eliminar vuelo</a>
...
<div class="row" >
        ...
        <div class="card-body">
        <form action="http://localhost:8080/eliminar-vuelo" method="get">

        <div class="form-row">
          <div class="form-row">
            <div class="form-group col-md-12">
              <label for="inputCity">Ingresa el id del vuelo a eliminar</label>
